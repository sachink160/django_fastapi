# Generated by Django 4.2 on 2025-06-02 10:20
...
import food.custom_auth.managers
import food.utils.utils
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, height_field='height_photo', null=True, upload_to=food.utils.utils.get_user_photo_random_filename, width_field='width_photo')),
                ...
                ('readable_password', models.CharField(blank=True, max_length=128, null=True)),
                ...
                ('phone', phonenumber_field.modelfields.PhoneNumberField(blank=True, error_messages={'unique': 'A user with that phone already exists.'}, max_length=128, null=True, region=None, unique=True, verbose_name='Mobile Number')),
                ...
                ('device_id', models.CharField(blank=True, max_length=256, null=True, verbose_name='Device Id')),
            ...
            managers=[
                ('objects', food.custom_auth.managers.ApplicationUserManager()),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_create_access', models.BooleanField(default=False, verbose_name='Create Access')),
                ('is_update_access', models.BooleanField(default=False, verbose_name='Update Access')),
                ('is_delete_access', models.BooleanField(default=False, verbose_name='Delete Access')),
                ('is_printed_access', models.BooleanField(default=False, verbose_name='Printed Access')),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('create_time', models.DateTimeField(auto_now_add=True)),
                ('update_time', models.DateTimeField(auto_now=True)),
                ('user_mobile', phonenumber_field.modelfields.PhoneNumberField(max_length=128, region=None)),
                ('otp', models.IntegerField()),
                ('expiration_time', models.DateTimeField(default=food.utils.utils.set_otp_reset_expiration_time)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('expiration_time', models.DateTimeField(default=food.utils.utils.set_otp_expiration_time)),
