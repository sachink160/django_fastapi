...
from food.custom_auth.managers import ApplicationUserManager
from food.custom_auth.mixins import UserPhotoMixin

from food.utils.utils import set_otp_expiration_time, set_otp_reset_expiration_time
...
class ApplicationUser(AbstractBaseUser, UserPhotoMixin, PermissionsMixin):
    ...
    def __str__(self):
        return self.username or self.email or self.first_name or self.last_name or self.str(uuid)
