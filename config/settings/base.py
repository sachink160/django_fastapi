...
MIDDLEWARE = [
    ...
    'food.custom_auth.middleware.TokenBlacklistMiddleware',
...
AUTHENTICATION_BACKENDS = (
    'food.custom_auth.auth_backends.model_backend.CustomModelBackend',
)
...
REST_FRAMEWORK = {
    ...
    'DEFAULT_RENDERER_CLASSES': [
        'food.utils.renderer.CustomRenderer'
    ],
    'PAGE_SIZE': 5,
    'DEFAULT_PAGINATION_CLASS': 'food.utils.paginator.CustomPagination',
}

# Project name
# ------------
PROJECT_FULL_NAME = env('PROJECT_FULL_NAME', default='food')
